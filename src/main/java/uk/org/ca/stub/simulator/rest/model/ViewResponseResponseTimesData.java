...
import uk.org.ca.stub.simulator.rest.model.RequestDetails;
import java.time.OffsetDateTime;
...
public class ViewResponseResponseTimesData {
  ...
  @Valid
  private List<@Valid RequestDetails> items = new ArrayList<>();

  public ViewResponseResponseTimesData() {
    super();
  }
   ...
   */
  public ViewResponseResponseTimesData(UUID holdernameGuid, UUID submissionId, UUID recordId, SubmissionStatusEnum submissionStatus, OffsetDateTime reportingPeriodStart, SubmissionReasonEnum submissionReason, List<@Valid RequestDetails> items) {
  ...
  public ViewResponseResponseTimesData holdernameGuid(UUID holdernameGuid) {
    this.holdernameGuid = holdernameGuid;
    return this;
  }
  ...
  */
  ...
  public ViewResponseResponseTimesData submissionId(UUID submissionId) {
    this.submissionId = submissionId;
    return this;
  }
  ...
  */
  ...
  public ViewResponseResponseTimesData recordId(UUID recordId) {
    this.recordId = recordId;
    return this;
  }
  ...
  */
  ...
  public ViewResponseResponseTimesData submissionStatus(SubmissionStatusEnum submissionStatus) {
    this.submissionStatus = submissionStatus;
    return this;
  }
  ...
  */
  ...
  public ViewResponseResponseTimesData reportingPeriodStart(OffsetDateTime reportingPeriodStart) {
    this.reportingPeriodStart = reportingPeriodStart;
    return this;
  }
  ...
  */
  ...
  public ViewResponseResponseTimesData submissionReason(SubmissionReasonEnum submissionReason) {
    this.submissionReason = submissionReason;
    return this;
  }
  ...
  */
  ...
  public ViewResponseResponseTimesData items(List<@Valid RequestDetails> items) {
    this.items = items;
    return this;
  }

  public ViewResponseResponseTimesData addItemsItem(RequestDetails itemsItem) {
    if (this.items == null) {
   ...
   * @return items
  */
  @NotNull @Valid @Size(min = 1, max = 1400) 
  @Schema(name = "items", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("items")
  public List<@Valid RequestDetails> getItems() {
    return items;
  }

  public void setItems(List<@Valid RequestDetails> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewResponseResponseTimesData viewResponseResponseTimesData = (ViewResponseResponseTimesData) o;
    return Objects.equals(this.holdernameGuid, viewResponseResponseTimesData.holdernameGuid) &&
        Objects.equals(this.submissionId, viewResponseResponseTimesData.submissionId) &&
        Objects.equals(this.recordId, viewResponseResponseTimesData.recordId) &&
        Objects.equals(this.submissionStatus, viewResponseResponseTimesData.submissionStatus) &&
        Objects.equals(this.reportingPeriodStart, viewResponseResponseTimesData.reportingPeriodStart) &&
        Objects.equals(this.submissionReason, viewResponseResponseTimesData.submissionReason) &&
        Objects.equals(this.items, viewResponseResponseTimesData.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewResponseResponseTimesData {\n");
