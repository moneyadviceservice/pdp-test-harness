...
public class NullSubmissionMultipleHolders {
  ...
  public NullSubmissionMultipleHolders() {
    super();
  }
   ...
   */
  public NullSubmissionMultipleHolders(UUID submissionId, UUID recordId, SubmissionStatusEnum submissionStatus, OffsetDateTime reportingPeriodStart, SubmissionReasonEnum submissionReason, List<UUID> items) {
  ...
  public NullSubmissionMultipleHolders submissionId(UUID submissionId) {
    this.submissionId = submissionId;
    return this;
  }
  ...
  */
  ...
  public NullSubmissionMultipleHolders recordId(UUID recordId) {
    this.recordId = recordId;
    return this;
  }
  ...
  */
  ...
  public NullSubmissionMultipleHolders submissionStatus(SubmissionStatusEnum submissionStatus) {
    this.submissionStatus = submissionStatus;
    return this;
  }
  ...
  */
  ...
  public NullSubmissionMultipleHolders reportingPeriodStart(OffsetDateTime reportingPeriodStart) {
    this.reportingPeriodStart = reportingPeriodStart;
    return this;
  }
  ...
  */
  ...
  public NullSubmissionMultipleHolders submissionReason(SubmissionReasonEnum submissionReason) {
    this.submissionReason = submissionReason;
    return this;
  }
  ...
  */
  ...
  public NullSubmissionMultipleHolders items(List<UUID> items) {
    this.items = items;
    return this;
  }

  public NullSubmissionMultipleHolders addItemsItem(UUID itemsItem) {
    if (this.items == null) {
  ...
  /**
   * Array of holdernameGuid values for null submission
   * @return items
  */
  @NotNull @Valid @Size(min = 1, max = 667) 
  @Schema(name = "items", description = "Array of holdernameGuid values for null submission", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("items")
  ...
  public boolean equals(Object o) {
    ...
    NullSubmissionMultipleHolders nullSubmissionMultipleHolders = (NullSubmissionMultipleHolders) o;
    return Objects.equals(this.submissionId, nullSubmissionMultipleHolders.submissionId) &&
        Objects.equals(this.recordId, nullSubmissionMultipleHolders.recordId) &&
        Objects.equals(this.submissionStatus, nullSubmissionMultipleHolders.submissionStatus) &&
        Objects.equals(this.reportingPeriodStart, nullSubmissionMultipleHolders.reportingPeriodStart) &&
        Objects.equals(this.submissionReason, nullSubmissionMultipleHolders.submissionReason) &&
        Objects.equals(this.items, nullSubmissionMultipleHolders.items);
  }

  @Override
  public int hashCode() {
    return Objects.hash(submissionId, recordId, submissionStatus, reportingPeriodStart, submissionReason, items);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NullSubmissionMultipleHolders {\n");
